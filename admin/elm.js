...
var _kenota$kommentator$Route$routeToString = function (route) {
	var path = function () {
		var _p0 = route;
		if (_p0.ctor === 'Home') {
			return '';
...
var _kenota$kommentator$Route$href = function (route) {
	return _elm_lang$html$Html_Attributes$href(
		_kenota$kommentator$Route$routeToString(route));
};
var _kenota$kommentator$Route$modifyUrl = function (_p1) {
	return _elm_lang$navigation$Navigation$modifyUrl(
		_kenota$kommentator$Route$routeToString(_p1));
};
var _kenota$kommentator$Route$Login = {ctor: 'Login'};
var _kenota$kommentator$Route$Home = {ctor: 'Home'};
var _kenota$kommentator$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_kenota$kommentator$Route$Home,
			_evancz$url_parser$UrlParser$s('')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_kenota$kommentator$Route$Login,
				_evancz$url_parser$UrlParser$s('login')),
			_1: {ctor: '[]'}
		}
	});
var _kenota$kommentator$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_kenota$kommentator$Route$Home) : A2(_evancz$url_parser$UrlParser$parseHash, _kenota$kommentator$Route$route, location);
};

var _kenota$kommentator$Page_Login$initialModel = {username: '', password: '', error: ''};
var _kenota$kommentator$Page_Login$Model = F3(
	function (a, b, c) {
		return {username: a, password: b, error: c};
	});
var _kenota$kommentator$Page_Login$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _kenota$kommentator$Page_Login$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _kenota$kommentator$Page_Login$viewLoginForm = function (model) {
	return A2(
								...
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_kenota$kommentator$Page_Login$SetUsername),
												_1: {ctor: '[]'}
											}
										}
									}
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_kenota$kommentator$Page_Login$SetPassword),
													_1: {ctor: '[]'}
												}
											}
										}
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('button is-block is-info is-large is-fullwidth'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _kenota$kommentator$Page_Login$Login = {ctor: 'Login'};

var _kenota$kommentator$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _kenota$kommentator$Main$decodeStatus = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'status',
	...
	_elm_lang$core$Json_Decode$string);
var _kenota$kommentator$Main$view = function (model) {
	var _p0 = model;
	switch (_p0.ctor) {
		case 'Bootstrap':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('boostrap'),
					_1: {ctor: '[]'}
				});
		case 'LoginRequired':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('loginRequired'),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('SetupRequired'),
					_1: {ctor: '[]'}
				});
	}
};
var _kenota$kommentator$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'None') {
...
var _kenota$kommentator$Main$ServerConfig = function (a) {
	return {url: a};
};
var _kenota$kommentator$Main$LoginRequired = {ctor: 'LoginRequired'};
var _kenota$kommentator$Main$SetupRequired = {ctor: 'SetupRequired'};
var _kenota$kommentator$Main$Bootstrap = {ctor: 'Bootstrap'};
var _kenota$kommentator$Main$Login = function (a) {
	return {ctor: 'Login', _0: a};
};
var _kenota$kommentator$Main$Blank = {ctor: 'Blank'};
var _kenota$kommentator$Main$NavigatingFrom = function (a) {
	return {ctor: 'NavigatingFrom', _0: a};
};
var _kenota$kommentator$Main$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _kenota$kommentator$Main$NotConfigured = {ctor: 'NotConfigured'};
var _kenota$kommentator$Main$Configured = {ctor: 'Configured'};
var _kenota$kommentator$Main$ServerStatus = function (a) {
	return {ctor: 'ServerStatus', _0: a};
};
var _kenota$kommentator$Main$getServerStatus = function () {
	var url = '/api/v1/status';
	var request = A2(_elm_lang$http$Http$get, url, _kenota$kommentator$Main$decodeStatus);
	return A2(_elm_lang$http$Http$send, _kenota$kommentator$Main$ServerStatus, request);
}();
var _kenota$kommentator$Main$init = {ctor: '_Tuple2', _0: _kenota$kommentator$Main$Bootstrap, _1: _kenota$kommentator$Main$getServerStatus};
var _kenota$kommentator$Main$main = _elm_lang$html$Html$program(
	{init: _kenota$kommentator$Main$init, view: _kenota$kommentator$Main$view, update: _kenota$kommentator$Main$update, subscriptions: _kenota$kommentator$Main$subscriptions})();
var _kenota$kommentator$Main$None = {ctor: 'None'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _kenota$kommentator$Main$main !== 'undefined') {
    _kenota$kommentator$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"None":[],"ServerStatus":["Result.Result Http.Error String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
